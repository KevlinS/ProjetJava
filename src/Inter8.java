...
public class Inter8 extends JFrame {
	...
	public Inter8() {
		...
		JLabel lblNewLabel_1 = new JLabel("À qui doit-on la chanson “I Shot the Sheriff” ? ");
		lblNewLabel_1.setForeground(new Color(255, 0, 0));
		lblNewLabel_1.setFont(new Font("Tahoma", Font.BOLD | Font.ITALIC, 26));
		lblNewLabel_1.setBounds(83, 96, 668, 107);
		contentPane.add(lblNewLabel_1);
		
		JButton btnNewButton = new JButton("a.UB40");
		...
		JButton button = new JButton("b.Bob Marley");
		...
		JButton button_1 = new JButton("c.Jim Morrison");	
		...
		JButton button_2 = new JButton("d.Eric Clapton");
